...
| 25/09 | A7 chamados de token e acesso, abertos a partir de 14/09 (C1); o MySQL RDS dispensa VPN (C8) · C7 RM/TOTVS. **A8 saiu daqui**: documentação recebida em 14/09 | **bloqueante, não atrasado**: 25/09 era a meta interna para abrir os chamados; o contrato dá até **19/10** para os tokens e **16/11** para VPN e credenciais (a pauta pediu 09/11). A ociosidade de 4h/dia só corre depois de 5 dias úteis além desses prazos. Em 25/09 a ness. preparou o lado GCP da rede e reiterou o pedido de rede local e credencial por e-mail |
