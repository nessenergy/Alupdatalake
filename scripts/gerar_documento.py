...
/* Bloco de comando ou de exemplo: é o que o leitor copia. Uma linha longa rola
   dentro do bloco em tela e quebra na impressão, sem emendar no texto. */
pre {
  margin: 1.5mm 0 3mm;
  padding: 2mm 3mm;
  background: var(--zebra);
...
def montar_html(texto_md: str, *, classe: str = "relatorio") -> str:
    ...
    # `fenced_code`: sem ela, um bloco entre crases vira código no meio da
    # linha, e o comando que a contratante precisa copiar sai emendado ao texto.
    corpo = markdown.markdown(texto_md, extensions=["tables", "attr_list", "fenced_code"])
